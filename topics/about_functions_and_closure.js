...
test("self invoking functions", function() {
    ...
    (function(pv) {
        ...
        equal("string", typeof (secretValue),
            "is secretValue available in this context?");
        equal("string", typeof (publicValue),
            "is publicValue available in this context?");
    })(publicValue);

    equal("undefined", typeof (secretValue),
        "is secretValue available in this context?");
    equal("string", typeof (publicValue),
        "is publicValue available in this context?");
});
...
test("using call to invoke function",function() {
    ...
    equal("I am this!Where did it come from?",
        result, "what will the value of invokee's this be?");
});
...
test("using apply to invoke function",function() {
    ...
    equal("I am this!I am arg1I am arg2",
        result, "what will the value of invokee's this be?");
});
